 ...
 */
// svg font id
var SVG_FONT_ID = _default["default"].fontId; // xml 模板
...
function ttfobject2svg(ttf, options) {
  ...
  xmlObject.missing.d = ttf.glyf[0].contours && ttf.glyf[0].contours.length ? 'd="' + (0, _contours2svg["default"])(ttf.glyf[0].contours) + '"' : ''; // glyf 信息
