 ...
 */
var _default = _table["default"].create('OS/2', [['version', _struct["default"].Uint16], ['xAvgCharWidth', _struct["default"].Int16], ['usWeightClass', _struct["default"].Uint16], ['usWidthClass', _struct["default"].Uint16], ['fsType', _struct["default"].Uint16], ['ySubscriptXSize', _struct["default"].Uint16], ['ySubscriptYSize', _struct["default"].Uint16], ['ySubscriptXOffset', _struct["default"].Uint16], ['ySubscriptYOffset', _struct["default"].Uint16], ['ySuperscriptXSize', _struct["default"].Uint16], ['ySuperscriptYSize', _struct["default"].Uint16], ['ySuperscriptXOffset', _struct["default"].Uint16], ['ySuperscriptYOffset', _struct["default"].Uint16], ['yStrikeoutSize', _struct["default"].Uint16], ['yStrikeoutPosition', _struct["default"].Uint16], ['sFamilyClass', _struct["default"].Uint16], // Panose
['bFamilyType', _struct["default"].Uint8], ['bSerifStyle', _struct["default"].Uint8], ['bWeight', _struct["default"].Uint8], ['bProportion', _struct["default"].Uint8], ['bContrast', _struct["default"].Uint8], ['bStrokeVariation', _struct["default"].Uint8], ['bArmStyle', _struct["default"].Uint8], ['bLetterform', _struct["default"].Uint8], ['bMidline', _struct["default"].Uint8], ['bXHeight', _struct["default"].Uint8], // unicode range
['ulUnicodeRange1', _struct["default"].Uint32], ['ulUnicodeRange2', _struct["default"].Uint32], ['ulUnicodeRange3', _struct["default"].Uint32], ['ulUnicodeRange4', _struct["default"].Uint32], // char 4
['achVendID', _struct["default"].String, 4], ['fsSelection', _struct["default"].Uint16], ['usFirstCharIndex', _struct["default"].Uint16], ['usLastCharIndex', _struct["default"].Uint16], ['sTypoAscender', _struct["default"].Int16], ['sTypoDescender', _struct["default"].Int16], ['sTypoLineGap', _struct["default"].Int16], ['usWinAscent', _struct["default"].Uint16], ['usWinDescent', _struct["default"].Uint16], // version 0 above 39
['ulCodePageRange1', _struct["default"].Uint32], ['ulCodePageRange2', _struct["default"].Uint32], // version 1 above 41
['sxHeight', _struct["default"].Int16], ['sCapHeight', _struct["default"].Int16], ['usDefaultChar', _struct["default"].Uint16], ['usBreakChar', _struct["default"].Uint16], ['usMaxContext', _struct["default"].Uint16] // version 2,3,4 above 46
], {
  read: function read(reader, ttf) {
    var format = reader.readUint16(this.offset);
    var struct = this.struct; // format2
    ...
    var tbl = new OS2Head(this.offset).read(reader, ttf); // 补齐其他version的字段
  ...
  size: function size(ttf) {
    ...
    var xMaxExtent = -16384; // os2 count

    var xAvgCharWidth = 0;
    var usFirstCharIndex = 0x10FFFF;
    var usLastCharIndex = -1; // maxp
    ...
    var hinting = ttf.writeOptions ? ttf.writeOptions.hinting : false; // 计算instructions和functiondefs
    ...
    ttf['OS/2'].usLastCharIndex = usLastCharIndex; // rewrite hhea
    ...
    ttf.hhea.xMaxExtent = xMaxExtent; // rewrite head
    ...
    ttf.head.yMin = yMin;
    ttf.head.xMax = xMax;
    ttf.head.yMax = yMax; // head rewrite
