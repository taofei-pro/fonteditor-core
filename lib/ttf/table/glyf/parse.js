 ...
 */
var MAX_INSTRUCTION_LENGTH = 20000; // 设置instructions阈值防止读取错误

var MAX_NUMBER_OF_COORDINATES = 40000; // 设置坐标最大个数阈值，防止glyf读取错误
...
function parseSimpleGlyf(reader, glyf) {
  var offset = reader.offset; // 轮廓点个数

  var numberOfCoordinates = glyf.endPtsOfContours[glyf.endPtsOfContours.length - 1] + 1; // 判断坐标是否超过最大个数
